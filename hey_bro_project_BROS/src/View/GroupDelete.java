...
public class GroupDelete extends JFrame{
	...
	public GroupDelete(Session session) {
		...
		label2.setBounds(350, 395, 100, 39);

		//?솗?씤 泥댄겕
		JRadioButton check = new JRadioButton();
		check.setBackground(null);
		check.setOpaque(false);
		check.setBounds(280, 352, 20, 20);

		//버튼 뒤로가기 양도하기
		Image backI = new ImageIcon("hey_bro_project_BROS/src/View/img/back.PNG").getImage().getScaledInstance(100, 30, 0);
		JButton back = new JButton(new ImageIcon(backI));
		back.setBounds(650, 25, 100, 30);
