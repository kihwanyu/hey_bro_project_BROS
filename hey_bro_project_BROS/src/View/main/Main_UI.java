...
public class Main_UI {
	...
	public void main_UI(){
		...
		//icon_ : 좌측버튼
		//icon : 우측버튼
		Image icon = new ImageIcon("img/main_1.PNG").getImage().getScaledInstance(140, 139, 0);
		...
		Image icon2 = new ImageIcon("img/main_2.PNG").getImage().getScaledInstance(140, 139, 0);
		...
		Image icon3 = new ImageIcon("img/main_3.PNG").getImage().getScaledInstance(139, 139, 0);
